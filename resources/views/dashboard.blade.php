                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 dark:text-white max-w-xs">
                                    ...
                                    @if (strlen($contact->message) > 120)
                                        <button onclick="toggleMessage({{ $contact->id }})" class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 mt-1">
                                            Read more
                                        </button>
                                        <div id="full-message-{{ $contact->id }}" class="hidden mt-2 text-sm text-gray-600 dark:text-neutral-300">
                                            {{ $contact->message }}
                                            <button onclick="toggleMessage({{ $contact->id }})" class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 mt-1 block">
                                                Show less
                                            </button>
                                        </div>
                                    @endif
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-1">
                            ...
                            @if($allContactUs->onFirstPage())
                                <span class="px-3 py-1 text-sm text-gray-400 dark:text-neutral-600 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded cursor-not-allowed">
                            Previous
                        </span>
                            @else
                                <a href="{{ $allContactUs->previousPageUrl() }}" class="px-3 py-1 text-sm text-gray-700 dark:text-neutral-300 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded hover:bg-gray-50 dark:hover:bg-neutral-600 transition-colors">
                                    Previous
                                </a>
                            @endif
                            ...
                            @foreach($allContactUs->getUrlRange(1, $allContactUs->lastPage()) as $page => $url)
                                @if($page == $allContactUs->currentPage())
                                    <span class="px-3 py-1 text-sm text-white bg-blue-600 border border-blue-600 rounded">
                                {{ $page }}
                            </span>
                                @else
                                    <a href="{{ $url }}" class="px-3 py-1 text-sm text-gray-700 dark:text-neutral-300 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded hover:bg-gray-50 dark:hover:bg-neutral-600 transition-colors">
                                        {{ $page }}
                                    </a>
                                @endif
                            @endforeach
                            ...
                            @if($allContactUs->hasMorePages())
                                <a href="{{ $allContactUs->nextPageUrl() }}" class="px-3 py-1 text-sm text-gray-700 dark:text-neutral-300 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded hover:bg-gray-50 dark:hover:bg-neutral-600 transition-colors">
                                    Next
                                </a>
                            @else
                                <span class="px-3 py-1 text-sm text-gray-400 dark:text-neutral-600 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded cursor-not-allowed">
